    ...
    private val webViewClient = object : WebViewClient() {
        ...
        override fun onPageFinished(view: WebView, url: String) {
            if (mWebview != null && mWebview!!.isAttachedToWindow) {
                ...
                if (activity is FolioActivityCallback) {
                    val callback = activity as FolioActivityCallback?
                    if (callback?.direction == Config.Direction.HORIZONTAL)
...
//                    mIsPageReloaded = false
                    ...
                    mWebview!!.loadUrl(
                        String.format(
                            getString(R.string.go_to_highlight),
                            highlightId
                        )
                    )
                    highlightId = null
