...
//                println("VProgress: $fmtProgress%")
    ...
    fun initViewTextSelection() {
        ...
        val yellowHighlight = viewTextSelection.findViewById<ImageView>(R.id.yellowHighlight)
        val greenHighlight = viewTextSelection.findViewById<ImageView>(R.id.greenHighlight)
        val blueHighlight = viewTextSelection.findViewById<ImageView>(R.id.blueHighlight)
        val pinkHighlight = viewTextSelection.findViewById<ImageView>(R.id.pinkHighlight)
        val underlineHighlight = viewTextSelection.findViewById<ImageView>(R.id.underlineHighlight)
        val deleteHighlight = viewTextSelection.findViewById<ImageView>(R.id.deleteHighlight)
        val copySelection = viewTextSelection.findViewById<TextView>(R.id.copySelection)
        val shareSelection = viewTextSelection.findViewById<TextView>(R.id.shareSelection)
        val defineSelection = viewTextSelection.findViewById<TextView>(R.id.defineSelection)
